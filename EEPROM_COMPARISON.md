...
- **G-222 (unit 2)**: Second physical G-222 (eeprom_backup_20260317_111631.bin, device ID 0x0522)
...
- **MCU**: STMicroelectronics L9805E — ST7 8-bit core, 16K mask-ROM, 256B RAM, 128B EEPROM,
  integrated CAN controller + transceiver, H-bridge motor driver, 10-bit ADC, PWM
- **Position sensor**: onsemi NCV77320 — Contactless Inductive Position Sensor (Hella "CIPOS"),
  communicates with MCU via SPI, has its own separate EEPROM (64×16-bit words)
- **Datasheets**: `datasheets/l9805e.pdf` (125p), `datasheets/ncv77320.pdf` (39p)

## EEPROM Structure
- 128 bytes total, mapped at MCU addresses 0x0C00h–0x0C7Fh
- Flat memory with no hardware sectors — all write protection is firmware-enforced
- Two-half structure: 0x00-0x3F and 0x40-0x7F (Hella firmware convention, not hardware)
- First half (0x00-0x3F): Active configuration
- Second half (0x40-0x7F): Mirror/backup, with NCV77320 sensor calibration at 0x4F-0x5F
- Addresses 0x0F-0x1F: Write-protected by firmware, managed by actuator during motor operations
- Addresses 0x3C-0x3F / 0x7C-0x7F: L9805E temperature sensor trim (factory-set by ST, not Hella)
...
| 4 | Unknown (0x00) | No |
| 5 | Temperature in °C. Derived from NCV77320 on-die sensor (formula: `temp[11:0] = 8 * (T[K] - 200)`). Confirmed with heat gun. | Yes |
...
| --------- | ---------- | ----------- | ----------- | ----------- | ------------------------------ | -------------------------------------- | ------------------------------------------------------------------- |
| 0x00(0)   | 0x07(7  )  | 0x05(5  )   | 0x05(5  )   |             |                                | Device ID high byte                    | Per-unit. G-222 u1=0x05, u2=0x05; G-221 dl=0x07, hw=0x05           |
| 0x01(1)   | 0xB2(178)  | 0x1E(30 )   | 0x0E(14 )   |             |                                | Device ID low byte                     | Per-unit. G-222 u1=0x0E, u2=0x22; G-221 dl=0xB2, hw=0x1E           |
| 0x02(2)   | 0x55(85 )  | 0x55(85 )   | 0x55(85 )   |             |                                | Magic number / format ID               | Always 0x55 across all known units (4 physical + 1 downloaded)      |
...
| 0x0D(13)  | 0x01(1  )  | 0x01(1  )   | 0x01(1  )   |             |                                | Model config ID high byte              | Constant per G-number variant. All units=0x01                       |
| 0x0E(14)  | 0x55(85 )  | 0x55(85 )   | 0x2A(42 )   |             |                                | Model config ID low byte               | G-222=0x2A(→0x012A=298), G-221=0x55(→0x0155=341). Gearbox/travel ID |
...
| 0x22(34)  | 0xAA(170)  | 0xAA(170)   | 0x00(0  )   |             |                                | Position zero offset                   | Analogous to NCV77320 pos_shift. Calibrates pos=0 at min endstop. Scale: ~4 counts/unit |
| 0x23(35)  | 0x2C(44 )  | 0x22(34 )   | 0x2D(45 )   |             | Default/fallback position      |                                        | Position actuator returns to when no commands received. Scale 0-200. |
...
| 0x2C(44)  | 0x32(50 )  | 0x32(50 )   | 0x06(6  )   |             |                                | Model-specific config                  | G-221=0x32, G-222=0x06. Model differentiator (PWM freq or scaling?) |
| 0x2D(45)  | 0x02(2  )  | 0x02(2  )   | 0x02(2  )   |             |                                |                                        | Same across all units (0x02)                                        |
| 0x2E(46)  | 0x1F(31 )  | 0x1F(31 )   | 0x1D(29 )   |             |                                | Model-specific config                  | G-221=0x1F, G-222=0x1D. Model differentiator (sensor scaling?)      |
| 0x2F(47)  | 0x09(9  )  | 0x09(9  )   | 0x09(9  )   |             |                                |                                        | Same across all units (0x09)                                        |


| 0x30(48)  | 0x00(0  )  | 0x00(0  )   | 0x00(0  )   |             |                                |                                        | Same across all units (0x00)                                        |
| 0x31(49)  | 0x2C(44 )  | 0x2D(45 )   | 0x2A(42 )   |             |                                | Motor/gearbox travel parameter         | Per-model. Complementary pair with 0x33: 0x31+0x33≈0xFF             |
| 0x32(50)  | 0x03(3  )  | 0x03(3  )   | 0x03(3  )   |             |                                |                                        | Same across all units (0x03)                                        |
| 0x33(51)  | 0xD3(211)  | 0xD1(209)   | 0xD5(213)   |             |                                | One's complement of 0x31               | Redundancy check: 0x31+0x33=0xFE or 0xFF. Physical travel/gear ratio|
...
| 0x3B(59)  | 0x52(82 )  | 0x52(82 )   | 0x54(84 )   |             |                                | Model-specific config                  | G-221=0x52, G-222=0x54. Model differentiator                        |
| 0x3C(60)  | 0x01(1  )  | 0x01(1  )   | 0x01(1  )   |             | L9805E temp trim T0H           |                                        | MCU addr 0x0C7C. Factory-set by ST per L9805E datasheet §5.5.6      |
| 0x3D(61)  | 0x8E(142)  | 0x8E(142)   | 0x8E(142)   |             | L9805E temp trim T0L           |                                        | MCU addr 0x0C7D. Factory-set by ST. Same on all 3 units here        |
| 0x3E(62)  | 0x01(1  )  | 0x01(1  )   | 0x01(1  )   |             | L9805E temp trim VT0H          |                                        | MCU addr 0x0C7E. Factory-set by ST                                  |
| 0x3F(63)  | 0xB0(176)  | 0xAE(174)   | 0xAC(172)   |             | L9805E temp trim VT0L          |                                        | MCU addr 0x0C7F. Per-chip: G-221dl=0xB0, hw=0xAE, G-222=0xAC       |
...
| 0x4F(79)  | 0xFF(255)  | 0xFF(255)   | 0xFF(255)   |             |                                | Separator/unused                       | Always 0xFF. First half counterpart (0x0F) is firmware-managed      |
| 0x50(80)  | 0xA4(164)  | 0xD3(211)   | 0x45(69 )   |             |                                | Config CRC/hash (NOT factory-fixed)    | **Changes on same unit** when config modified (0x45→0x79→0xA3 on G-222 u1). Always byte[0]=byte[1] |
| 0x51(81)  | 0xA4(164)  | 0xD3(211)   | 0x45(69 )   |             |                                | Config CRC/hash (mirrors 0x50)         | Always equals 0x50. Rolling checksum or NCV77320 register shadow    |
| 0x52(82)  | 0x10(16 )  | 0x10(16 )   | 0x10(16 )   |             | NCV77320 sensor cal constant   |                                        | Same across ALL known units (0x10). Config flag or scale factor     |
| 0x53(83)  | 0x2F(47 )  | 0x08(8  )   | 0x2E(46 )   |             |                                | NCV77320 coupling compensation         | Per-unit, stable across time. Likely dcc_c12/dcc_c23 coefficients   |
| 0x54(84)  | 0xDB(219)  | 0x8D(141)   | 0x5B(91 )   |             |                                | NCV77320 coupling compensation         | Per-unit. Compensates PCB coil manufacturing tolerances              |
| 0x55(85)  | 0x00(0  )  | 0x00(0  )   | 0x00(0  )   |             |                                | NCV77320 coupling compensation         | Per-unit (G-222 u2=0x05). MCU programs into NCV77320 via SPI at boot|
| 0x56(86)  | 0xD0(208)  | 0xA0(160)   | 0x5E(94 )   |             |                                | NCV77320 coupling compensation         | Per-unit.                                                           |
| 0x57(87)  | 0x03(3  )  | 0x01(1  )   | 0x09(9  )   |             |                                | NCV77320 coupling compensation         | Per-unit.                                                           |
| 0x58(88)  | 0x5C(92 )  | 0x6A(106)   | 0xBA(186)   |             |                                | NCV77320 coupling compensation         | Per-unit.                                                           |
| 0x59(89)  | 0x71(113)  | 0x71(113)   | 0x71(113)   |             | NCV77320 sensor type ID (high) |                                        | Same across ALL units. From NCV77320 SENT sent_sensor_type register |
| 0x5A(90)  | 0x21(33 )  | 0x21(33 )   | 0x21(33 )   |             | NCV77320 sensor type ID (low)  |                                        | Same across ALL units. 0x59-0x5A = 0x7121                           |
| 0x5B(91)  | 0x22(34 )  | 0x22(34 )   | 0x22(34 )   |             | NCV77320 manufacturer code     |                                        | Same across ALL units (0x22). From NCV77320 sent_manufacturer_code  |
| 0x5C(92)  | 0x21(33 )  | 0x21(33 )   | 0x22(34 )   |             | **G-number variant ID**        |                                        | **0x22=G-222, 0x21=G-221.** Encodes G-number variant in NCV77320    |
| 0x5D(93)  | 0x00(0  )  | 0x00(0  )   | 0x01(1  )   |             |                                | Per-model config                       | G-222 u1=0x01, u2=0x00; G-221=0x00                                  |
| 0x5E(94)  | 0x15(21 )  | 0x56(86 )   | 0x61(97 )   |             |                                | Per-unit identifier                    | Per-unit, stable across time                                        |
| 0x5F(95)  | 0x0E(14 )  | 0x08(8  )   | 0x05(5  )   |             |                                | Per-unit identifier                    | Per-unit, stable across time                                        |
...
| 0x63(99)  | 0x2C(44 )  | 0x22(34 )   | 0x2D(45 )   |             |                                | Mirror: Default/fallback position      | Mirrors 0x23                                                        |
...
| 0x7C(124) | 0x01(1  )  | 0x01(1  )   | 0x01(1  )   |             | L9805E temp trim T0H           |                                        | Same physical bytes as 0x3C (MCU addr 0x0C7C). Not a mirror — same silicon location |
| 0x7D(125) | 0x8E(142)  | 0x8E(142)   | 0x8E(142)   |             | L9805E temp trim T0L           |                                        | Same physical bytes as 0x3D (MCU addr 0x0C7D)                       |
| 0x7E(126) | 0x01(1  )  | 0x01(1  )   | 0x01(1  )   |             | L9805E temp trim VT0H          |                                        | Same physical bytes as 0x3E (MCU addr 0x0C7E)                       |
| 0x7F(127) | 0xB0(176)  | 0xAE(174)   | 0xAC(172)   |             | L9805E temp trim VT0L          |                                        | Same physical bytes as 0x3F (MCU addr 0x0C7F). Per-chip variation   |
